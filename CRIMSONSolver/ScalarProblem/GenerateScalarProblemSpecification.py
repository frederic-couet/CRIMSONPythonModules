...
def _FormatSpecification(fluidIterations, iterations, diffusionCoefficients, scalarNames, reactionCoefficients, coefficientSymbolSection, scalarSymbolsSection, symbolsSection, reactionExpressions):
    return _generatedCodeTemplate.format(fluidIterations, iterations, diffusionCoefficients, scalarNames, reactionCoefficients, coefficientSymbolSection, scalarSymbolsSection, symbolsSection, reactionExpressions)
...
def GenerateSpecification(fluidIterations, solverIterations, diffusionCoefficientsDict, scalarNamesList, reactionCoefficientsDict, reactionStringsDict):
    iterationsLiteral = _ObjectToJSON(solverIterations)
    diffusionCoefficientsLiteral = _ObjectToJSON(diffusionCoefficientsDict)
    scalarNamesLiteral = _ObjectToJSON(scalarNamesList)
    ...
    scalarsDefinitions = _CreateSymbolDefinitionSection(scalarNamesList)

    symbolNames = []
    for scalarName in scalarNamesList:
    ...
    return _FormatSpecification(fluidIterations, iterationsLiteral, diffusionCoefficientsLiteral, scalarNamesLiteral, reactionCoefficientsLiteral, coefficientsDefinitions, scalarsDefinitions, symbolNamesLiteral, reactionExpressionsLiteral)
